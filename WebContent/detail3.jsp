...
<body>
	...
	<div class="container-fluid" id="align_center">
		<div class="row">
			...
			<div class="col-6">
				<h3><span>【sleepy tofu】眠豆腐標準雙人床架+床墊</span></h3>
				<p><span> 符合歐盟低甲醛 E1 等級</span></p>
				<p><span> 細緻的斜角處理，避免人體碰傷</span></p>
                <p><span> 無框設計，環保水性漆塗裝</span></p>		
                <p><span> 商品編號 : <c:out value="${itemID}"/></span></p>
                <hr size="8px" width="100%">
                <h3>商品規格</h3>
                <p>商品尺寸(寬/長/高)(cm) : 154 x 193 x 69/12 (床墊 : 寬152 x 長188 x 高28)</p>
                <p>床架材質 : 胡桃木</p>
                <hr size="8px" width="100%">
                <h3>每月租金計算</h3>
