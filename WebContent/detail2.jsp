...
<body>
	...
	<div class="container-fluid" id="align_center">
		<div class="row">
			...
			<div class="col-6">
				<h3><span>【obis】Nivia北歐實木雙人床架+床墊</span></h3>
				<p><span> 北歐簡約造型，搭配居家風格</span></p>
				<p><span> 實木床腳，床架穩固耐用</span></p>
                <p><span> 圓潤邊角設計</span></p>
               
                <p><span> 商品編號 : <c:out value="${itemID}"/></span></p>
                <hr size="8px" width="100%">
                <h3>商品規格</h3>
                <p>商品尺寸(寬/長/高)(cm) : 152 x 202 x 89 (床墊 : 寬150 x 長186)</p>
                <p>床架材質 : 白橡木實木</p>
                <hr size="8px" width="100%">
                <h3>每月租金計算</h3>
