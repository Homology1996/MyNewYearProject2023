...
<body>
	...
	<div class="container-fluid" id="align_center">
		<div class="row">
			...
			<div class="col-6">
				<h3><span>【HappyLife】極簡風實木腳書桌</span></h3>
				<p><span> 實木桌腳，耐重穩固不易搖晃</span></p>
				<p><span> 抽拉便捷實木滑軌</span></p>
                <p><span> 邊角塗漆處理，質感光滑細膩</span></p>			
                <p><span> 商品編號 : <c:out value="${itemID}"/></span></p>
                <hr size="8px" width="100%">
                <h3>商品規格</h3>
                <p>商品尺寸(長/寬/高)(cm) : 120 x 55 x 72 (抽屜 : 長28/6 x 寬55)</p>
                <p>書桌材質 : 實木</p>
                <hr size="8px" width="100%">
                <h3>每月租金計算</h3>
